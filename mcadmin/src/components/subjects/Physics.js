...
import "./Common.css";
import Physicsfp from "../chapters/Physicsfp";
import Physicssp from "../chapters/Physicssp";
...
const Physics = () => {
    ...
    useEffect(() => {
        const checkServer = async () => {
            return await fetch("https://momins-care-backend.onrender.com")
                .then((res) => {
                    setLoading(false);
                    return res;
                })
        ...
        try {
            ...
            if (response.ok) {
                if (valueArrey.length === 0 && questionImg === "") {
                    ...
                    const paper =
                        event.target.paper.value == "physics1st"
                            ? "phy1st"
                            : "phy2nd";
                    console.log(paper);
                    ...
                    <div>
                        ...
                        <form onSubmit={handleAddQue}>
                            ...
                            <div id="firstChapters">
                                ...
                                <Physicsfp onClick={selectChapter}></Physicsfp>
                            </div>
                            <div id="secondChapters">
                                {/* <Second onClick={selectChapter}></Second> */}
                                <Physicssp onClick={selectChapter}></Physicssp>
                            </div>
                            <input
                                type="text"
                                name="topic"
